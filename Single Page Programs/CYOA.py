...
if answer == "sleep":
    ...
    if answer == "eat":
        ...
        if answer == "drive":
            answer = input("You decided to drive to work, however you hit rush hour and end up being an hour late for work. You lose.")
...
#! print("Invalid input, you lose.") ((Haven't finished program yet so this is commented out till I am done)) 